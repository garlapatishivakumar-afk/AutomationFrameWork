...
public static class DependencyInjection
{
        ...
        this IServiceCollection services)
    {
        ...
        services.AddSingleton<IRepositoryDigestService, RepositoryDigestService>();
        services.AddSingleton<IFileContentCacheService, FileContentCacheService>();
        services.AddSingleton<IDeterministicRetrievalService, DeterministicRetrievalService>();
        services.AddSingleton<IAiEscalationPolicy, AiEscalationPolicy>();
        services.AddSingleton<IAiContextPackBuilder, AiContextPackBuilder>();
        services.AddSingleton<IValidationImpactAnalyzer, ValidationImpactAnalyzer>();
